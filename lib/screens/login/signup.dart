...
import '../user/SignUpInformation.dart';
                  ...
                  child: ElevatedButton(
                    onPressed: () async {
                        if(_repasswordController.text != _passwordController.text){
                          ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Xác nhận mật khẩu không đúng, nhập lại mật khâu")));
                        }
                        else if(_passwordController.text.length < 8){
                          ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Mật khẩu quá ngắn(từ 8 kí tự)")));
                        }
                        else{
